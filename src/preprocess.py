...
#     cols_to_encode = [col for col in categorical_cols if col != target_column]
...
#     encoded_df[target_column] = target_encoder.fit_transform(encoded_df[target_column])
...
#     encoded_df, encoders = encode_categorical_columns(cleaned_df, target_column)
#     X, y = split_features_and_target(encoded_df, target_column)
#     return X, y, encoders
#-------------------------------------------------------------------new-------------------------------------------
